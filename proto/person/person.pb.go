...
type Person struct {
	...
	Name   int32  `protobuf:"varint,2,opt,name=name,proto3" json:"name,omitempty"`
	Salary int32  `protobuf:"varint,3,opt,name=salary,proto3" json:"salary,omitempty"`
	Child  *Child `protobuf:"bytes,4,opt,name=child,proto3" json:"child,omitempty"`
}
...
var fileDescriptor_4c9e10cf24b1156d = []byte{
	...
	,
}
...
func (m *Child) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Salary != 0 {
		i = encodeVarintPerson(dAtA, i, uint64(m.Salary))
		i--
		dAtA[i] = 0x18
	}
	if m.Name != 0 {
		i = encodeVarintPerson(dAtA, i, uint64(m.Name))
		i--
		dAtA[i] = 0x10
	}
	if m.Age != 0 {
...
func (m *Child) Size() (n int) {
	...
	if m.Name != 0 {
		n += 1 + sovPerson(uint64(m.Name))
	}
	if m.Salary != 0 {
		n += 1 + sovPerson(uint64(m.Salary))
	}
	return n
}
